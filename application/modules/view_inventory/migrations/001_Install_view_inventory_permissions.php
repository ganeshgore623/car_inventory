...
class Migration_Install_view_inventory_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'View_inventory.Content.View',
			'description' => 'View View_inventory Content',
			'status' => 'active',
		),
		array(
			'name' => 'View_inventory.Content.Delete',
			'description' => 'Delete View_inventory Content',
			'status' => 'active',
		),
    );
